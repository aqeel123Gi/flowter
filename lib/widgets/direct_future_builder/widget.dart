...
class DirectFutureBuilder<T> extends StatefulWidget{
  ...
  final Widget Function(BuildContext context, DirectFutureState state, T data) builder;
...
class _DirectFutureBuilderState<T> extends State<DirectFutureBuilder<T>> {
  ...
  final DirectFutureBuilderWidgetController<T> _controller = DirectFutureBuilderWidgetController<T>();
  ...
  Widget build(BuildContext context) {
    return WidgetControllerBuilder<DirectFutureBuilderWidgetController>(
        ...
        builder: (context, c) => _controller.init?widget.builder(context, _controller.directFutureState, _controller.data as T):const SizedBox()
    );
  }
