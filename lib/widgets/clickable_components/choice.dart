...
import 'package:framework/controllers/global_future/global_future.dart';
...
class _ChoiceState<T> extends State<Choice<T>> {
  ...
  Widget get _content {
    if(widget.choices!=null){
      ...
      return Text(widget.choices![widget.currentChoice!]!,style: widget.choiceStyle);
    }
    ...
    if(widget.futureChoices!=null){
      ...
      return Text(widget.futureChoices!.data![widget.currentChoice!]!,style: widget.choiceStyle);
    }
          ...
          child: FilledButtonAsset(
            ...
            child: Row(children: [
              ...
              AnimatedContainer(
                ...
                widget.titleDecorationOnDisabled : widget.titleDecoration,
                child: Center(child: Text(widget.title!,style: widget.titleStyle))
              ),
