...
class _CenterPopupState extends State<CenterPopup> {
  ...
  height() {
    if(_height>(Window.height(context)-MediaQuery.of(context).viewInsets.bottom)*0.8){
      return (Window.height(context)-MediaQuery.of(context).viewInsets.bottom)*0.8 +4;
    }
            ...
            child: Stack(
                ...
                children: [
                  ...
                  AnimatedPositioned(
                      ...
                      duration: Duration(milliseconds: _durationSeconds),
                      bottom:
                      (_inMiddle? (MediaQuery.of(context).size.height * 0.5) - (height() * 0.5) + MediaQuery.of(context).padding.bottom : _bottom) +
                      ...
                      child: AnimatedOpacity(
                          ...
                          Blur(
                              ...
                              constraints: BoxConstraints(
                                  maxWidth: min(Window.width(context)*0.8,400)
                              ),
                              ...
                              child: SingleChildScrollView(padding: EdgeInsets
                                  .zero,
                                  child: ChildSizeDetector(child: widget.child,
                                      onChange: (Size size) {
                                      if (!initialized) {
                                        initialized = true;
...
Widget? stackedChild,
  ...
  showTransparentPage(context, CenterPopup(
