...
class _AdvScrollerBuilderState extends State<AdvScrollerBuilder> {
  ...
  void _updateThumbPosition(){
    setState((){
      _thumbPosition = widget.scrollController.offset/widget.scrollController.position.maxScrollExtent * (_widthLayout-widget.thumbHeight);
    });
  }
                ...
                child: GestureDetector(
                    ...
                    onVerticalDragUpdate: (details){
                      setState(() {
                        ...
                        _thumbPosition = _thumbPosition.clamp(0, constraints.maxHeight - widget.thumbHeight);
                      });
                      widget.scrollController.jumpTo((_thumbPosition/(_widthLayout-widget.thumbHeight)) * widget.scrollController.position.maxScrollExtent);
                    },
                    onVerticalDragEnd: (_){
    ...
    child: SizedBox(
      ...
      child: LayoutBuilder(
          builder: (context,constraints) {
            ...
            return Stack(
              children: [AnimatedPositionedDirectional(
                duration: widget.duration,
                curve: widget.curve,
                ...
                child: GestureDetector(
                    ...
                    onHorizontalDragUpdate: (details){
                      setState(() {
                        ...
                        _thumbPosition = _thumbPosition.clamp(0, constraints.maxWidth - widget.thumbHeight);
                      });
                      widget.scrollController.jumpTo((_thumbPosition/(_widthLayout-widget.thumbHeight)) * widget.scrollController.position.maxScrollExtent);
                    },
