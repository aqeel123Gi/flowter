...
class Time implements Comparable<Time>{
  ...
  int differenceInSeconds(Time time){
    return ((hour-time.hour)*3600)+((minute-time.minute)*60)+(second-time.second);
  }
  ...
  DateTime getNextDateTime(){
    ...
    nextDateTime = nextDateTime.add(Duration(hours: hour,minutes: minute,seconds: second));
  ...
  Duration difference(Time time){
    return Duration(hours: hour-time.hour,minutes: minute-time.minute,seconds: second-time.second);
  }
