...
class XlsxDecoder extends SpreadsheetDecoder {
  ...
  void _parseContent() {
    ...
    if (workbook == null) {
      throw Exception('workbook.xml not found');
    }
    if (workbook.content == null) {
      throw Exception('workbook.xml content is null');
    }
    workbook.decompress();
  ...
  void _parseTable(XmlElement node) {
    ...
    if (file == null) {
      throw Exception('$namePath not found');
    }
    if (file.content == null) {
      throw Exception('$namePath content is null');
    }
    file.decompress();
